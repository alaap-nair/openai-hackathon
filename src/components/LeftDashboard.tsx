...
export const LeftDashboard: React.FC<LeftDashboardProps> = ({ isVisible }) => {
  if (!isVisible) return null;

  return (
    <div className="fixed top-0 left-0 w-80 h-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white shadow-2xl z-40 overflow-y-auto">
